...
// Icons are shipped as static SVG files under public/icons/ and referenced by URL.
// Sources: LinkedIn — Simple Icons (CC0); Pakistan — Wikimedia Commons (PD).
const BASE = import.meta.env.BASE_URL;
const ICONS = {
  linkedin: `<img src="${BASE}icons/linkedin.svg" width="18" height="18" alt="" aria-hidden="true" class="btn__icon-img btn__icon-img--linkedin" />`,
  'pk-flag': `<img src="${BASE}icons/pakistan.svg" width="24" height="16" alt="" aria-hidden="true" class="btn__icon-img btn__icon-img--flag" />`,
};
