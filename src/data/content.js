...
export const about = {
  ...
  paragraphs: [
    ...
    "The work is quantified — USD 10 million+ in DFI defaulted-loan recoveries; USD 450 million+ in major engine components and auxiliaries secured under the closing 22-year Wärtsilä O&M contract at Gul Ahmed Energy; the privatisation handover of National Fibers Ltd.; the technical audit of Creek Marina Pakistan; direct CPEC procurement liaison across Thar Coalfield Block 1 (7.8 MTPA) and the Dhabaiji Special Zone.",
...
export const experience = {
  ...
  items: [
    ...
    },
    {
      ...
      duration: '1 yr 6 mos',
      role: 'Non-Executive Director — Renowned Investment Group',
    ...
    },
    {
      ...
      duration: '3 mos',
      role: 'Director, Projects',
      company: 'Enormity Group of Companies',
      location: 'Bahrain · Pakistan',
      type: 'Part-time',
      blurb:
    ...
    },
    {
      ...
      type: 'Full-time',
      blurb:
        'Owned safe and efficient operation of the complex; managed planned and routine maintenance on Wärtsilä 18V46 engines under the Power Purchase Agreement. Contract management with OEMs and third-party vendors, budgeting and forecasting for spares, supervision of 20+ contractor projects, and risk/contingency planning. Negotiated directly with Wärtsilä Finland; secured USD 450 million+ in replacement of major engine components and auxiliaries before the 22-year O&M contract closed — a milestone for the company.',
      outcome: 'USD 450 M+ in Wärtsilä 18V46 components & auxiliaries secured — 22-year O&M closed at milestone.',
      skills: ['Customer Satisfaction', 'Business Development'],
      moreSkills: 14,
    },
    {
      period: 'Mar 1992 — Jun 1997',
      duration: '5 yrs 4 mos',
      role: 'D.G.M. Engineering & Projects — National Fibers Ltd.',
  ...
  items: [
    {
      ...
      detail: 'MOT 1st Class Certificate of Competency — Naval Architecture & Marine Engineering',
    },
    {
      school: 'Postgraduate Institute of Management (PIM)',
      detail: 'Postgraduate Diploma in Anti–Money Laundering & Fraud Detection · Crisis Management',
    },
    {
      school: 'Morgen Consulting',
      detail: 'Professional Diploma in F&ML: PD&I · 2019',
    },
    {
