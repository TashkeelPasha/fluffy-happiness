  ...
  items: [
    {
      ...
      type: 'Pakistan Advisory Board',
      blurb:
        'Accelerating cross-border collaboration and responsible growth across 525+ cities.',
    },
    {
      period: '2023 — Present',
      ...
      type: 'Hybrid',
      blurb:
        'Strategic vision and business development for an international advisory house — three years on, the work continues to scale.',
    },
    {
      period: '2025 — Present',
      role: 'Director, Strategic Growth',
      company: 'Wrackler Pvt. Ltd.',
      location: 'Karachi, Pakistan',
      type: 'Contract',
      blurb:
        'Partnerships, market transformation, and integrated infrastructure solutions for an industrial growth platform.',
    },
    {
      period: 'Ongoing',
      role: 'Academic Advisor',
      company: 'Academic Window LLC',
      location: 'United States',
      type: 'Advisory',
      blurb:
        'Strategic guidance to educational institutions — policy development and alignment with international standards.',
    },
    {
      period: '2024 — Present',
      ...
      type: 'Full-time',
      blurb:
        'Infrastructure maintenance, project engineering and governance oversight on the board of a private mandate.',
    },
    {
      period: '2020 — Present',
      ...
      type: 'Full-time',
      blurb:
        'Procurement SME across major international infrastructure and energy construction zones, including CPEC, Thar Coalfield Block 1, and Dhabaiji Special Zone.',
    },
  ],
};
